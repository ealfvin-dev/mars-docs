            ...
            <div className='about'>
                <Grid container spacing={3}>
                    <Grid item xs={9}>
                        ...
                        <br/> <br/>
                        For improved reliability, MARS is designed to check input data for consistency and identify any errors that may have occured during data entry. This makes troubleshooting fast 
